...
export const ColumnSchema = {
	...
	properties: {
		...
		data_type: {
			$ref: "#/components/schemas/PostgresDataType",
		},
		default_value: {
			type: ["string", "null"],
		},
...
export const ConstraintSchema = {
	type: "object",
	required: ["name", "columns", "constraint_type"],
	properties: {
		columns: {
			type: "array",
			items: {
...
export const EnumTypeSchema = {
	type: "object",
	required: ["oid", "name", "schema_name", "variants"],
	properties: {
		name: {
			type: "string",
		},
...
export const PostgresDataTypeSchema = {
	oneOf: [
		{
			type: "object",
			required: ["type"],
...
export const ReferentialActionSchema = {
	type: "string",
...
export const TriggerSchema = {
	type: "object",
	required: ["name", "event_manipulation", "action_statement", "action_timing"],
	properties: {
		action_condition: {
			type: ["string", "null"],
		},
...
export const ViewSchema = {
	type: "object",
	required: ["oid", "name", "schema_name", "definition", "is_updatable"],
	properties: {
		definition: {
			type: "string",
		},
